...
class SemanticViewsStyle extends StylePluginBase {
  ...
  public function buildOptionsForm(&$form, FormStateInterface $form_state) {
    ...
    $form['row']['attributes'] = [
      ...
      '#description' => t('Enter one value per line, in the format attribute|value. Insert a %hash where you want row enumeration with start 0, if enumeration with start 1 use %hash%hash.', ['%hash' => '#']),
    ];
